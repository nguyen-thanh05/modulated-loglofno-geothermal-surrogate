...
for config in configs/homogeneous_dataset/fno_m8x32x16_h64_homo.yml configs/heterogeneous_dataset/fno_m8x32x16_h64_hetero.yml \
              ...
              configs/homogeneous_dataset/unet_d3_homo.yml configs/heterogeneous_dataset/unet_d3_hetero.yml \
              configs/homogeneous_dataset/unet_d4_homo.yml configs/heterogeneous_dataset/unet_d4_hetero.yml \
